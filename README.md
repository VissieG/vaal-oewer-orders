...
- **Close & show bill** saves, settles the table (kept for records), and shows the bill as an on-screen popup to show the customer (no printing).
- Tap a **closed** table → the whole bill **read-only**, with **View bill** (on-screen popup) and **Email** (email coming soon).
